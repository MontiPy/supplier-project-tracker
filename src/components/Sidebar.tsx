...
import { Home, Users, FolderKanban, Library, Package, BarChart3, Settings, HelpCircle, ArrowLeftRight, FileText } from 'lucide-react';
...
const secondaryNavigation = [
  { name: 'Project Templates', href: '/project-templates', icon: FileText },
